node {
  ...
  stage 'Run Service'
    sh "aws ecs create-service --service-name move-service --cluster moveStack-ECSCluster-1SOEI3DPIYM9F --task-definition moveStackmove-ecs --desired-count 1 --launch-type EC2 --role ecsInstanceRole"
}
